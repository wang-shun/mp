			...
			var DetailMeeting = CommunicationBaseView
					.extend({
						...
						_initTable : function(){
							...
							tableObj.aoColumns=[
							{"sTitle":"文档名称","sWidth":"50%","mDataProp":"fileName","sDefaultContent": "" ,"sClass":"left","bSortable":false},
							{"sTitle":"文档类型","sWidth":"15%","mDataProp":"contentType","sDefaultContent": "" ,"sClass":"center","bSortable":false},
							...
							{"sTitle":"操作","sWidth":"10%","mDataProp":"cz","sDefaultContent": "" ,"sClass":"center","bSortable":false,"fnRender":function(o,val){
								...
								//	str = '<a href="javascript:void(0)" class="grey" data-url="'+o.aData.downloadUrl+'"><span class="fhicon-download"></span>下载</a>';
								//else if(o.aData.privilege == '下载')
									str = '<a href="javascript:void(0)" class="SID-attach" data-url="'+o.aData.downloadUrl+'"><span class="fhicon-download"></span>下载</a>';
