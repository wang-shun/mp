					...
					.extend({
						...
						_setContentHTML : function (){
							...
							//if(this.data.routeDetail != null){
								commonDialog =fh.commonOpenDialog('routeDetailDialog', this.data.title, 780, 500, this.el);
							//	this._fillData(this.data);
							//}else{
							//	commonDialog =fh.commonOpenDialog('routeAddDialog', this.data.title, 780, 500, this.el);
							//}
