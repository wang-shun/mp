					...
					.extend({
						...
						_setContentHTML : function (){
							...
							if(this.data.redisDetail != null){
								commonDialog =fh.commonOpenDialog('measurementEditDialog', this.data.title, 780, 500, this.el);
                                this._fillData(this.data);
							}else{
								commonDialog =fh.commonOpenDialog('measurementAddDialog', this.data.title, 780, 500, this.el);
							}
