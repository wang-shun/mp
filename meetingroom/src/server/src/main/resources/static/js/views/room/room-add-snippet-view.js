						...
						_initData:function(room){
							...
							if(room){// 修改
								...
								if(room.imagePath == null){
									...
									self.$el.find(".img-show").css({"display":"block","background-image":"url("+room.imagePath+")","background-size":"contain","background-repeat":"no-repeat","background-position":"center"});
