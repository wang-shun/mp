		...
		function($, CommunicationBaseView,TemplateRight,datatableUtil,datatableLnpagination) {
			...
			.extend({
				...
				reservedList : function(){
					...
					{"sTitle":"开始时间","sWidth":"10%","mDataProp":"reservedStartTime","sDefaultContent": "","bSortable":false ,"sClass":"center"},
					{"sTitle":"结束时间","sWidth":"10%","mDataProp":"reservedEndTime","sDefaultContent": "" ,"bSortable":false,"sClass":"center"},
					{"sTitle":"会议名称","sWidth":"20%","mDataProp":"meetingName","sDefaultContent": "" ,"sClass":"center","bSortable":false},
					{"sTitle":"预定状态","sWidth":"20%","mDataProp":"statusStr","sDefaultContent": "" ,"sClass":"center","bSortable":false,"fnRender":function(o,val){
						if (o.aData.status == "1") {
							return "准备中";
					...
					{"sTitle":"操作","sWidth":"11%","mDataProp":"cz","sDefaultContent": "" ,"sClass":"center","bSortable":false,"fnRender":function(o,val){
						var str = "";
						if (o.aData.status == "1" || o.aData.status == "a") {
							...
							str = '<a href="javascript:void(0)" class="SID-delReserved" data-reservedId="'+o.aData.reservedId+'"><span class="fhicon-eye"></span>删除</a>';
						}
