...
public class DateUtil
{
     ...
     * 格式化含 时 分 秒
     */
    private static SimpleDateFormat sdfHMS     = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    /**
     * 一天当中小时的最大值
     */
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        Date a = d.sdf.parse("2016-01-04");
        Date b = d.sdf.parse("2016-01-04");
        List<String> list = DateUtil.convertList(a, b);
        for (String s : list)
        {
