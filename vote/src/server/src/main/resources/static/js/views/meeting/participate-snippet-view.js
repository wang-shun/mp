define(
		[ 'jquery', 'views/communication-base-view','text!../../templates/meeting/participateTemplate.html','util/datatableUtil','datatable_lnpagination'
		...
		function($, CommunicationBaseView,Template,datatableUtil,datatableLnpagination,MeetingDetailView) {
			var treeObj;
			var ParticipateSnippetView = CommunicationBaseView
					.extend({
						events : {
						...
						meetingList : function(that,operate){
							...
							var servicePath = appContext.cashUtil.getData('servicePath');
							var ropParam = appContext.cashUtil.getData('ropParam');
							var url = servicePath + "?" + ropParam + "&method=mapps.meeting.meeting.webquery&order=1&selfStatus=2" + param;
							tableObj.url = url;
							//控制是否可分页
							tableObj.bPaginate = true;
							tableObj.aoColumns=[
							{"sTitle":"会议名称","sWidth":"15%","mDataProp":"meetingName","sDefaultContent": "" ,"sClass":"left","bSortable":false},
							{"sTitle":"会议召开人","sWidth":"15%","mDataProp":"holderName","sDefaultContent": "" ,"sClass":"left","bSortable":false},
							{"sTitle":"会议开始时间","sWidth":"9%","mDataProp":"beginTimeStr","sDefaultContent": "" ,"sClass":"left"},
							{"sTitle":"会议结束时间","sWidth":"9%","mDataProp":"endTimeStr","sDefaultContent": "" ,"sClass":"left"},
							{"sTitle":"会议地址","sWidth":"9%","mDataProp":"address","sDefaultContent": "" ,"sClass":"left","bSortable":false},
