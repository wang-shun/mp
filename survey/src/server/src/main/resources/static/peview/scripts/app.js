...
//    }
    var app = {
        ...
        pages:{
            ...
            clientDetail:"ID-PageClientDetail",
            addDetail:"ID-PageAddDetail"
        },
        isBack:false,
        ropMethod:{
        	...
        	previewTemplate:"format=json&v=1.0&appKey=&method=mapps.surveyTemplate.preview",//&sessionId="+window.token,
