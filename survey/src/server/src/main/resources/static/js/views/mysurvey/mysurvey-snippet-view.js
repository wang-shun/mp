define(
		[ 'jquery' , 'views/communication-base-view','util/datatableUtil','datatable_lnpagination'
		  ,'text!../../templates/mysurvey/mysurveyTemplate.html'
		  ...
		  ,'views/statistics/mystatistics-snippet-view'],
			...
			var RoomSnippetView = CommunicationBaseView
					.extend({
						...
						_initSurveyList : function(){
							...
							var url = servicePath + "?" + ropParam + "&method=mapps.survey.mysurvey" + param;
							...
							tableObj.aoColumns=[
							{"sTitle":"问卷名称","mDataProp":"title1","sDefaultContent": "" ,"sClass":"left","fnRender":function(o,val){
								var str = '<a href="javascript:void(0)" class="SID-listop-peview" data-roomId="'+o.aData.id+'">'+o.aData.title+'</a>';
								return str;
							}},
							{"sTitle":"开始时间","sWidth":"150px","mDataProp":"effectiveTime","sDefaultContent": "" ,"sClass":"center","fnRender":function(o,val){
								return o.aData.effectiveTimeStr;
							}},
							{"sTitle":"结束时间","sWidth":"150px","mDataProp":"endTime","sDefaultContent": "" ,"sClass":"center","fnRender":function(o,val){
								return o.aData.endTimeStr;
							}},
							{"sTitle":"问卷状态","sWidth":"150px","mDataProp":"mystatus","sDefaultContent": "" ,"sClass":"center","fnRender":function(o,val){
								var str="";
								if (o.aData.mystatus==1){
									str = "未填写";
								} else if (o.aData.mystatus==2){
									str = "已填写";
								} else if (o.aData.mystatus==3){
									str = "已结束";
								} 
								return str;
							}},
						...
						_onClickStatisticsBtn:function(e){
							...
							this.childrenView.statisticsView = new StatisticsView({el : $(".SID-mysurvey-stat")});
				        ...
				        _onClickPeviewBtn:function(e){
							...
							//window.open("http://127.0.0.1/#ID-PageMeetDetail/ad4fb391-0293-480f-aad4-88f64509ced3");
							window.open("peview.html#ID-PageAddDetail/"+roomId);
							return;
...
//										self.childrenView.roomViewSnippetView.render(data,roomId);
				                	}
				                }
							});
				        },
...
//										}
						...
						_beforeSubmit:function(nextPageFlag){
							...
							var title = page1Obj.find(".SID-survey-title").val();
							...
							for(var i=0,liObj; liObj=questionliObjs[i++];) {
								...
								var questionTitle = $(liObj).find(".SID-question-title").val();
								var suQuestionObj = {
								...
								switch(type)
								{
							        case "1":
							        	...
							        	for(var j=0,ddObj; ddObj=ddObjs[j++];) {
							        		var optionTitle = $(ddObj).find(".SID-option-title").val();
							        		var customInput = $(ddObj).attr("custom_input");
							        		var optionObj = {
							        			option:optionTitle,
							        			customInput:customInput,
