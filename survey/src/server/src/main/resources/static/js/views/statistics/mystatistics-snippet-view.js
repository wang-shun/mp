define(
		[ 'jquery', 'views/communication-base-view','text!../../templates/statistics/myStatisticsTemplate.html'
		  , 'views/statistics/myroomStat-snippet-view', 'views/statistics/userRecoed-snippet-view'],
