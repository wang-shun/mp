define([
    ...
    var view = Backbone.View.extend({
        ...
        /*=========================
          ...
          ===========================*/
        _onStat:function(e){
            var hash="#"+app.pages.statDetail+"/"+this.surveyId;
        ...
        _submitBack:function(){
        	...
        	//self._resetDom();
        	app.routerViews.meetDetailView.refresh(this.surveyId);
        	this.$el.find("#ID-stat-Btn").click();
            //history.go(-1);
        },
        _resetDom:function(){
        	var self = this;
