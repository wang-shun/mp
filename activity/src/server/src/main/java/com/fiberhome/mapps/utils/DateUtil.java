...
public class DateUtil
{
     ...
     * 格式化含 时 分 秒
     */
    private static final SimpleDateFormat sdfHMS()
    {
        return new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    }

    private static final SimpleDateFormat sdfHM()
    {
    ...
    public static String timeToString(Date time) throws Exception
    {
        return sdfHMS().format(time);
    }
