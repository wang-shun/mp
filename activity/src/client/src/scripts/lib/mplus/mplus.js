...
Mplus.chooseLocation=function(success,fail){
...
Mplus.Image=function(params){
    ...
    s.target=null,s.uploadList=[],s.uploadIndex=0,s.downList=[],s.downIdList=[],s.downIndex=0,s.downObjList=[];
    /*================
    Method
    ================*/
    ...
    s.downAll=function(downIdList){
        ...
        mplus.downloadImage({
            ...
            success:function(res){
                ...
                obj.downloadUrl = res.downloadUrl;
                s.downObjList.push(obj);
                //Callback onDownloadSuccess
                e.target=s.target;
                s.params.onDownloadSuccess(e);
                s.downIndex++;
    ...
    s.choose=function(target){
        ...
        mplus.chooseImage({
            ...
            success:function(res){
                ...
                s.params.onChooseSuccess && s.params.onChooseSuccess(e);
                //初始化上传队列
                s.uploadList=[];
                s.uploadIndex=0;
                //初始化下载队列
