define(['jquery', 'views/communication-base-view', ''], function($,CommunicationBaseView, TemplateMenu) {
	var MenuSnippetView = CommunicationBaseView.extend({
		...
		setUpContent: function() {
			var html = '<li class="nav-category-list"><a class="SID-menu" data-name="订单查询"><span class="line"></span><span class="fhicon-meeting-set"></span>订单查询</a></li>' ;
//			html += '<li class="nav-category-list"><a class="SID-menu" data-name="订单统计"><span class="line"></span><span class="fhicon-meeting-clock"></span>订单统计</a></li>'
			this.$el.append(html);
			this.defauleMenu();
		}
	});
