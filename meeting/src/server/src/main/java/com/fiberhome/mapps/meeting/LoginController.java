package com.fiberhome.mapps.meeting;
...
public class LoginController
{
    ...
    @RequestMapping("/EX/{uuid}")
    public ModelAndView externalLogin(@PathVariable String uuid)
    {
        ModelAndView mv = new ModelAndView();
        mv.setViewName("redirect:" + webUrl + "/external/index.html#external/" + uuid + "/"
                + java.net.URLEncoder.encode(webUrl));
        return mv;
    }
    ...
    public ModelAndView webSso(@RequestParam String sessionId, @RequestParam(name= "orgUuidDefault", required = false) String orgId,
