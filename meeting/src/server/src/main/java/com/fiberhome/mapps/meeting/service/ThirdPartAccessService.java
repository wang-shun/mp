...
public class ThirdPartAccessService
{
     ...
     * @throws Exception
     */
    @ServiceMethod(method = "mapps.thirdpart.mobileark.getdocurl", group = "thirdpart", groupTitle = "获取预览下载地址", version = "1.0", ignoreSign = IgnoreSignType.YES, needInSession = NeedInSessionType.NO)
    ...
    @ServiceMethod(method = "mapps.thirdpart.mobileark.getdepartments", group = "thirdpart", groupTitle = "文件服务", version = "1.0", ignoreSign = IgnoreSignType.YES, needInSession = NeedInSessionType.NO)
    ...
    {
        LOGGER.debug("获取用户信息,{}, {}", orgUuid, loginIds);
    ...
    public boolean pushReceiveEvent(String ecid, String userIds, String title, String content, String meetingId)
    {
        ...
        try
        {
            ...
            {
                scheme = "index.html#ID-PageMeetDetail/" + meetingId;
            }
