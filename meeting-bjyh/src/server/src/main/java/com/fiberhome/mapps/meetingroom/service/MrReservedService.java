...
public class MrReservedService
{
     ...
     * @return
     */
    // @ServiceMethod(method = "mapps.meetingroom.reserved.delete", group = "reserved", groupTitle = "API", version =
    ...
    // mrReservedServiceV20.pushEvent(entity, MrReservedServiceV20.PUSH_TYPE_ADMIN_CANCEL,
    // SessionContext.getEcId(), mm.getId());
    ...
    // Map<String, Object> map = new HashMap<String, Object>();
    // map.put("status", targetStatus);
    // map.put("reservedId", entity.getId());
    // mrReservedMapper.syncStatusToMeetingByReservedId(map);
