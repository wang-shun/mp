define([ 'jquery', 'views/communication-base-view','text!../../templates/privilege/leftTemplate.html','text!../../templates/privilege/leftTableTemplate.html'],
			...
			var LeftsideSnippetView = CommunicationBaseView
					.extend({
						...
						refresh: function() {
							...
							var url = servicePath + "?" + ropParam + "&method=mapps.meetingroom.room.queryfromWebPage&offset=1&limit=100&timestamp=0" + param;
