					...
					.extend({
						...
						_setContentHTML : function (){
							...
							if(this.data.operation == 1){
								commonDialog =fh.servicemanagerOpenDialog('roomEditDialog', this.data.title, 780, 500, this.el);
								this._fillData(this.data);
							}else{
								commonDialog =fh.servicemanagerOpenDialog('roomAddDialog', this.data.title, 780, 500, this.el);
