			...
			var AddSnippetView = CommunicationBaseView
					.extend({
		                ...
		                _fillData : function(data){
		                	...
		                	this.$el.find(".SID-remarks").val(data.redisDetail.remarks);
		                },
				        ...
				        _addForm:function(commonDialog){
				        	...
				        	this._sumbitForm(commonDialog,method,"新增服务",self._closeMethod);
				        },
						...
						_sumbitForm : function(commonDialog,method,title,closeMethod){
						    ...
						    if(this.validateResult()){
				                ...
				                databaseInfo.remarks = this.$el.find(".SID-remarks").val();
