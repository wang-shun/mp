			...
			var AddSnippetView = CommunicationBaseView
					.extend({
						...
						_setContentHTML : function (){
							...
							this.$el.append(html);
							var commonDialog;
							commonDialog =fh.servicemanagerOpenDialog('fieldAddDialog', this.data.title, 680, 400, this.el,null,null,null,self.parentView.dialog);
...
//										}
                        ...
                        _exalert:function(info,ischild,handler){
                        	var _self = this;
							fh.servicemanagerAlert(info,true,handler,_self.dialog,null);
                        },
