define(
		[ 'jquery', 'views/communication-base-view','text!../../templates/redisdatabasemanage/createTemplate.html'
			...
			var AddSnippetView = CommunicationBaseView
					.extend({
						...
						_setContentHTML : function (){
							...
							this.$el.append(html);
							var commonDialog;
							commonDialog =fh.servicemanagerOpenDialog('dbCreateDialog', this.data.title, 390, 280, this.el);
		                ...
		                _checkForm : function(){
		                	...
		                	if(this.$el.find(".SID-admin").val() == "" || this.$el.find(".SID-pass").val() == ""){
		                		this.$el.find(".SID-wrongtext").html("123");
		                		return false;
		                	}else{
		                		return true;
		                	}
