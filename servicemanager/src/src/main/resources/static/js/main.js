requirejs.config({
	...
	paths: {
		...
		"gridstack_jQueryUI":"lib/gridStack/gridstack.jQueryUI",
        ...
        "jsonviewer":"lib/jsonviewer/jquery.jsonview"
	...
	shim: {
        ...
        "jqueryUiTimepicker": {
            deps: ["jquery","jqueryUi",'css!lib/jquery/timepicker/jquery-ui-timepicker-addon.css'],
        ...
        "editableselect": {
            deps: ['css!lib/editableselect/jquery-editable-select.css'],
            exports: "editableselect"
        },
        "jsonviewer": {
            deps: ['css!lib/jsonviewer/jquery.jsonview.css'],
            exports: "jsonviewer"
        },
        "gridstack": {
            deps: ['css!lib/gridStack/gridstack.css'],
            exports: "gridstack"
        }
	}
});
