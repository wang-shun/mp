 ...
 * 
 * Modeify By Aco Zhangwenjian  Fiberhome --添加选中触发函数参数 options.onSelect 暂只返回text和value
 */
...
+(function ($) {
	...
	EditableSelect.prototype.select = function ($li) {
		...
		if(this.options.onSelect != undefined){
			this.options.onSelect(this.utility.showli($li));
		}
	};
	...
	EditableSelectUtility.prototype.showli = function ($li) {
		var liobj = {
			text:$li.text(),
			value:$li[0].attributes[0].nodeValue,
		};
		return liobj;
	};
